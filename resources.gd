...
enum Scene {MAIN_MENU, GAME, DINOPARK, BUY, DINOS, STAFF, SCIENCE, MAP, MENU, RESUMES_SCIENTISTS, RESUMES_CAREGIVERS, BIRDS, GROCERIES, BUILD_ENCLOSURE, GARDEN_CENTER, SCIENTIST_ACTIONS, INCUBATOR, PLACE_EGG, DINOSAUR_CREATION_LINE, FOOD_CREATION_LINE, INGREDIENT, INCUBATOREGG, INVENTORY, INVENTORY_ITEM, DINOSAUR_LINE, GROCERY_ITEM, SCIENTIST_RESUME, RESUME_EGG, RESUME_FOOD, SCIENTIST_BUTTON, BIRD_LINE, BIOME_BUTTON, FENCE_BUTTON}
